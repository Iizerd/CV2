...
#define IrTraceToGroupEnd(GroupStart, TraceStop) _IrTraceToGroupEnd((PINST_LINK)GroupStart, (PINST_LINK)TraceStop)
...
//Return null terminated array of PINST_LINK
PINST_LINK* _IrEnumerateBlock(PINST_BLOCK Block, UINT32 Count);
#define IrEnumerateBlock(Block, Count) _IrEnumerateBlock((PINST_BLOCK)Block, Count)
