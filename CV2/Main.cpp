...
UCHAR test2[] = { 0x48, 0x8B, 0x40, 0x0C };
...
int main()
{
	...
	xed_decoded_inst_zero_set_mode(&decoded_inst, &XedGlobalMachineState);
	xed_decode(&decoded_inst, test2, 4);

	printf("size = %u\n", xed_decoded_inst_get_length(&decoded_inst));
	xed_decoded_inst_set_memory_displacement(&decoded_inst, 1776, 4);
	printf("size = %u\n", xed_decoded_inst_get_length(&decoded_inst));
